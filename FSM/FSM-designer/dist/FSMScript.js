...
function drawLine(position) {
  if(arrowClicked == 1){
    ...
    if(dragStartLoc.x < position.x){
      if(dragStartLoc.y < position.y){
        context.lineTo(position.x, position.y-5);
        context.moveTo(position.x, position.y);
        context.lineTo(position.x-5, position.y);
      }
      else if(dragStartLoc.y > position.y){
        context.lineTo(position.x, position.y+5);
        context.moveTo(position.x, position.y);
        context.lineTo(position.x-5, position.y);
      }
    ...
    else if (dragStartLoc.x > position.x){
      if(dragStartLoc.y < position.y){
        context.lineTo(position.x, position.y-5);
        context.moveTo(position.x, position.y);
        context.lineTo(position.x-5, position.y);
      ...
      if(dragStartLoc.y < position.y){
        context.lineTo(position.x-5, dragStartLoc.y-5);
        context.moveTo(position.x, position.y);
        context.lineTo(position.x+5, dragStartLoc.y-5);
